...
The above plot suggests that the residual become higher at lower prediction value, meaning that the model will not fit the data well when the prediction value goes to too small.
